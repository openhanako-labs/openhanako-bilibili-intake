...
import * as intakeDocument from "../tools/intake-document.js";
import * as intakeSummary from "../tools/intake-summary.js";
...
// ⭐ W3（2026-09-26）：删除记录与产物（助手可操作删除）。
import * as intakeForget from "../tools/intake-forget.js";
// ⭐ W2（2026-09-26）：画面分析（帧分析）单独入口 —— 对着已有记录说“看看这片子的画面结构”。
import * as intakeShots from "../tools/intake-shots.js";

const MODULES = [videoIntake, intakeDocument, intakeSummary, knowledgeMap, intakeHealth, intakeRouting, intakeForget, intakeShots];
